...
// store current data from built-in date object
const date = new Date();
...
// store weekday name, month name & day of month number
const weekDayName = getWeekDayName(date.getDay());
const monthName = getMonthName(date.getMonth());
const dayOfMonth = date.getDate();

// update headerTime date
headerTime.textContent = `${weekDayName}, ${monthName} ${dayOfMonth}`;
...
const elementToggler = function (element) { element.classList.toggle("active"); }
...
const addEventOnMultiElement = function (elements, event) {
...
const addTask = function () {
    ...
    addEventOnMultiElement(taskRemover, removeTask);
...
// toggle active class on menu click when click on menuBtn or dropdownLink
const toggleMenu = function () { elementToggler(menu); }
addEventOnMultiElement(menuTogglers, toggleMenu);

// toggle active class on modal when click on dropdownLink or modal Okay button
const toggleModal = function () { elementToggler(modal); }
addEventOnMultiElement(modalTogglers, toggleModal);

/*
    * add "loaded" class on body when website if fully loaded
*/
...
/*
    * change background when click on any themeBtn
*/
...
addEventOnMultiElement(themeBtns, themeChanger);
